...
<div class="bg-stone-200">
    <div class="max-w-7xl mx-auto sm:px-4 pt-12 pb-0 sm:pb-10">
            ...
            <div class="grid md:grid-cols-3 gap-8 mt-16">
                ...
                <!-- Empty Cart -->
                    <div v-for="(item, index) in 3" :key="index" class="grid grid-cols-3 items-start gap-6 py-4 border-b border-gray-300">
                ...
                <div class="bg-gray-100 rounded-md p-4 h-max sticky sm:relative bottom-0 inset-x-0 w-full">
                    <h3 class="text-lg max-sm:text-base font-bold text-gray-800 border-b border-gray-300 pb-2">Order Summary</h3>

                    <ul class="text-gray-800 mt-6 space-y-3">
                        <li class="flex flex-wrap gap-4 text-sm">Total <span class="ml-auto font-bold">$200.00</span></li>
                        <li class="flex flex-wrap gap-4 text-sm">Shipping <span class="ml-auto font-bold">Free</span></li>
                        <hr class="border-gray-300" />
                        <li class="flex flex-wrap gap-4 text-sm font-bold">SubTotal <span class="ml-auto">$200.00</span></li>
                    </ul>
