...
<div class="bg-[#081134] col-span-2">
  ...
  <div class="max-w-[630px] mx-auto px-4">
    <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-200 mb-4 md:mb-8 text-center">Register</h1>
    <form>
      ...
      <div>
        ...
        checked
          id="checkbox"
          type="checkbox"
          class="hidden peer bg-transparent"/>
        <label
          for="checkbox"
    ...
    <div class="py-4 md:py-6 flex justify-center">
      <RouterLink
        to="/login"
        class="hover:text-[#636eab] text-gray-200 flex gap-1 items-center">
