...
<template>
    ...
    <div class="game relative">
      <div class="group overflow-hidden rounded-tr-lg rounded-tl-lg"
        ...
        <div class="relative">
          ...
          <img
            ...
            alt=""
            class="w-full transition-opacity duration-500 delay-150"
          />
          <img
            v-else
            ...
            alt=""
            class="w-full transition-opacity duration-300 delay-150"
          />
          <span
            class="absolute left-0 top-0 inline-flex items-center rounded-br-md bg-red-500 px-2 py-1 text-xs font-medium text-white shadow-none" >-55%</span>
      ...
      <div class="grid grid-cols-3 gap-2">
        <h3 class="text-gray-800 font-bold line-clamp-2 col-span-2">Warstride Challenges</h3>
