...
<template>
  ...
  <div>
    <img src="https://gaming-cdn.com/img/products/10140/hcover/1400x500/10140.jpg?v=1725274116" alt="" class="firstImg w-full"/>
  </div>
<div class="p-4 sm:p-9">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8 md:mb-20 ">
      <div class="">
    <!-- Main Carousel -->
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-20 mb-8 md:mb-20">
<div>
  <h1 class="text-xl md:text-2xl font-semibold text-gray-600 mb-3 md:mb-4">
        About
      </h1>
      <p class="text-gray-900 line-clamp-5">
        Embody the superhuman skill and brutality of a Space Marine. Unleash deadly abilities and devastating weaponry to obliterate the relentless Tyranid swarms. Defend the Imperium in spectacular third-person action in solo or multiplayer modes. Fight the enemies of Mankind as Lieutenant Demetrian Titus in this sequel to 2011’s Space Marine, and prove your loyalty once again as you are reinstated to the Ultramarines. Hold at bay the horrors of the galaxy in epic
      </p>
        <router-link to="/support" class="hover:text-[#535C91] text-gray-900 underline">Read more.</router-link>
</div>
<div class="">
  <router-link to="/support" class="gap-2 item-center mb-4 hidden md:flex">
...
<div class="flex gap-8">
  ...
  <ul>
    <li class="text-gray-900 hover:text-[#535C91] cursor-pointer">How to activate your game</li>
    <li class="text-gray-900">PEGI 18</li>
    <li class="text-gray-900 hover:text-[#535C91] cursor-pointer">Saber Interactive</li>
    <li class="text-gray-900 hover:text-[#535C91] cursor-pointer">Focus Home Interactive</li>
    <li class="text-gray-900">9 September 2024</li>
    <li class="">
      <RouterLink to="#" class="text-gray-900 hover:text-[#535C91] cursor-pointer">Action,</RouterLink>
      <RouterLink to="#" class="text-gray-900 hover:text-[#535C91] cursor-pointer"> Adventure,</RouterLink>
      <RouterLink to="#" class="text-gray-900 hover:text-[#535C91] cursor-pointer"> RPG</RouterLink>
    </li>
    <li class="text-gray-600">Very positive <span class="text-black">(61405)</span></li>
  </ul>
</div>
</div>
    </div>
  ...
  <div class="mb-8 md:mb-20">
    <h1 class="text-xl font-semibold text-gray-600 mb-4">
      ...
      <div class="rounded-lg min-h-32 p-3 md:flex  justify-center items-center md:gap-6 gap-3 bg-stone-300">
          <div class="gap-2 item-center flex mb-3 md:mb-0">
  <div class="border-4 border-green-600 rounded-full p-3 font-semibold  text-green-600 h-12 w-12 flex items-center justify-center">
<span>10</span>
  </div>
  <div class="">
    <span class="text-[#535C91] font-semibold">Game review score</span>
    <p class="text-gray-600">based on 142 reviews, all languages included
    </p>
  </div>
</div>
        <div class="">
          <button class="bg-[#535C91] hover:bg-[#384176] flex gap-1 items-center justify-center text-gray-200 rounded-lg px-3 py-2 transition-all  text-sm md:text-lg">
...
<style scoped>
/* Optional styling for the thumbnails */
.thumbnails {
  display: flex;
