...
<div class="">
    <div class="max-w-7xl mx-auto">
        <h1 class="text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-700 py-4 sm:py-6 md:py-8 lg:py-10 text-center">
            Gear for Every Gamer
        </h1>

        <div class="flex gap-3 flex-col sm:flex-row justify-between items-center p-3 mx-4 mb-4 bg-stone-50 border rounded-md"> 
                    <p class="text-gray-600 text-sm font-semibold">32 Results</p>
                    <div class="flex items-center gap-1 sm:gap-2">
                        <button class="p-1 sm:p-2 border border-slate-200 hover:border-slate-400 rounded transition duration-300 ease focus:border-slate-300 shadow-sm focus:shadow-md">
                        ...
                        <div class="relative w-48">
                            <select class="w-full bg-transparent placeholder:text-slate-400 text-[#535C91] text-sm border border-slate-200 rounded pl-2 sm:pl-3 pr-4 sm:pr-8 py-1 sm:py-2 transition duration-300 ease focus:outline-none focus:border-slate-300 hover:border-slate-300 shadow-sm focus:shadow-md appearance-none cursor-pointer">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.2" stroke="currentColor" class="h-5 w-5 ml-1 absolute top-1.5 sm:top-2.5 right-1.5 sm:right-2.5 text-[#535C91]">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 15 12 18.75 15.75 15m-7.5-6L12 5.25 15.75 9" />
                            </svg>
                        </div>

                        <button @click="openFilters" class="lg:hidden p-1 sm:p-2 border border-slate-200 hover:border-slate-400 rounded transition duration-300 ease focus:border-slate-300 shadow-sm focus:shadow-md">
        ...
        <div class="flex lg:gap-4 mx-4">
            <div class="w-[30%] hidden lg:inline">
                <div class="w-full">
                    <div class="mx-auto w-full max-w-md rounded-md bg-stone-50 border p-3">
                        <Disclosure v-slot="{ open }" defaultOpen>
                            <DisclosureButton class="flex w-full justify-between p-2 font-medium hover:text-[#535C91] active:text-[#535C91]">
                                <span>Categories</span>
                                <ChevronUpIcon :class="open ? 'rotate-180 transform' : ''" class="h-5 w-5 hover:text-[#535C91] active:text-[#535C91]" />
                            </DisclosureButton>
                            <DisclosurePanel class="px-2 py-3">
                                <ul>
                                    <li v-for="(item, index) in 10" :key="index" class="mb-1 flex items-center justify-between">
                                        <router-link to="#" class="hover:text-[#8a88d6]">Action</router-link>
...
<div v-if="isOpen" class="fixed inset-0 overflow-y-auto bg-black/70 z-50">l̥</div>
<Footer />
</template>
